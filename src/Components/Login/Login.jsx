...
const Login = ({fullname, handleSubmit, handleFullnameChange}) => {
  return (
    <div>
...
<button className='w-full text-white bg-emerald-600 hover:bg-emerald-800 focus:ring-0 outline-none focus:outline-none font-medium rounded-md py-2.5 mt-8' onSubmit={handleSubmit} >submit</button>
